...
export const YEARLY_OVERVIEWS: Record<WorkshopId, Record<GradeId, YearlyOverviewUnit[]>> = {
  reader: {
    ...
    "4": [
      { grade: "4", id: "Close Reading of Fiction: Character and Theme", title: "Close Reading of Fiction: Character and Theme", window: "Start of Year", focus: "Launch close reading work centered on character change and theme.", standards: ["RL.4.1", "RL.4.2", "RL.4.3", "RL.4.4", "RL.4.5", "RL.4.10"], standardsPlaceholder: "Core CCSS aligned from the official RUOS Common Core correlation document and confirmed against the 2026 sequence of units." },
      { grade: "4", id: "Digging into Nonfiction: Rocks and Volcanoes", title: "Digging into Nonfiction: Rocks and Volcanoes", window: "Early Year", focus: "Use content-rich nonfiction to strengthen knowledge building and evidence work.", standards: ["RI.4.1", "RI.4.2", "RI.4.3", "RI.4.4", "RI.4.5", "RI.4.7", "RI.4.8", "RI.4.9", "RI.4.10"], standardsPlaceholder: "Core CCSS aligned from the official RUOS Common Core correlation document and confirmed against the 2026 sequence of units." },
      { grade: "4", id: "Drama-Ready Reading: Bringing Characters to Life", title: "Drama-Ready Reading: Bringing Characters to Life", window: "Middle of Year", focus: "Deepen character interpretation through expressive, performance-oriented reading.", standards: ["RL.4.1", "RL.4.3", "RL.4.4", "RL.4.6", "RL.4.10"], standardsPlaceholder: "Best-fit CCSS based on the 2026 sequence title and the closest older RUOS character-focused unit in the official correlation document." },
      { grade: "4", id: "Deep Reading of Biography", title: "Deep Reading of Biography", window: "Later Year", focus: "Study biography as a genre for knowledge, inspiration, and interpretation.", standards: ["RI.4.1", "RI.4.2", "RI.4.3", "RI.4.4", "RI.4.6", "RI.4.7", "RI.4.8", "RI.4.9", "RI.4.10"], standardsPlaceholder: "Best-fit CCSS based on the 2026 sequence title and biography trade-book list; newer Mossflower map still preferred for exact alignment." },
      { grade: "4", id: "Historical Fiction", title: "Historical Fiction", window: "End of Year", focus: "Support genre study through context, interpretation, and historical understanding.", standards: ["RL.4.1", "RL.4.2", "RL.4.3", "RL.4.4", "RL.4.5", "RL.4.6", "RL.4.7", "RL.4.9", "RL.4.10"], standardsPlaceholder: "Core CCSS aligned from the official RUOS Common Core correlation document and confirmed against the 2026 sequence and local historical fiction planning notes." },
    ],
    "5": [
